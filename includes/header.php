            ...
            <div class="order-2 md:order-3 flex items-center" id="nav-content">
                <a class="pl-3 inline-block no-underline hover:text-red-700" href="../cart.php">
                    <span class="relative inline-block">
                        ...
                        <span class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full"><?=$quantity = array_key_exists('cart', $_SESSION) ? sizeof($_SESSION['cart']) : 0?></span>
                    </span>
                </a>
            </div>
        </div>
